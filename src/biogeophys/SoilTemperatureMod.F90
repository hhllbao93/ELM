...
!hh!  use ExternalModelConstants   , only : EM_PTM_TBASED_SOLVE_STAGE
...
!hh!         update_temperature = .false.
!hh!        call Prepare_Data_for_EM_PTM_Driver(bounds, &
!hh!             num_nolakec_and_nourbanc,              &
!hh!             filter_nolakec_and_nourbanc,           &
!hh!             sabg_lyr_col(begc:endc, -nlevsno+1:),  &
!hh!             dhsdT( begc:endc ),                    &
!hh!             hs_soil( begc:endc ),                  &
!hh!             hs_top_snow( begc:endc ),              &
!hh!             hs_h2osfc( begc:endc ),                &
!hh!             energyflux_vars                        &
!hh!             )
!hh!
!hh!        call EMI_Driver(EM_ID_PTM,                                      &
!hh!             EM_PTM_TBASED_SOLVE_STAGE,                                 &
!hh!              dt = dtime,                               &
!hh!              clump_rank  = bounds%clump_index,                          &
!hh!              num_nolakec_and_nourbanc = num_nolakec_and_nourbanc,       &
!hh!              filter_nolakec_and_nourbanc = filter_nolakec_and_nourbanc, &
!hh!              num_filter_lun = num_filter_lun,                           &
!hh!              filter_lun = filter_lun,                                   &
!hh!              waterstate_vars = waterstate_vars,                         &
!hh!              energyflux_vars = energyflux_vars,                         &
