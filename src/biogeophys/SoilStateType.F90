...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    integer :: begc, endc
    integer :: begg, endg
!hh!    integer :: begc_all, endc_all
    !------------------------------------------------------------------------

    begp     = bounds%begp    ; endp     = bounds%endp
    begc     = bounds%begc    ; endc     = bounds%endc
    begg     = bounds%begg    ; endg     = bounds%endg
!hh!    begc_all = bounds%begc_all; endc_all = bounds%endc_all
...
!hh!    allocate(this%hksat_col            (begc_all:endc_all,nlevgrnd))    ; this%hksat_col            (:,:) = spval
...
!hh!    allocate(this%bsw_col              (begc_all:endc_all,nlevgrnd))    ; this%bsw_col              (:,:) = spval
!hh!    allocate(this%watsat_col           (begc_all:endc_all,nlevgrnd))    ; this%watsat_col           (:,:) = spval
    allocate(this%bsw_col              (begc:endc,nlevgrnd))            ; this%bsw_col              (:,:) = spval
    allocate(this%watsat_col           (begc:endc,nlevgrnd))            ; this%watsat_col           (:,:) = spval
...
!hh!    allocate(data_recv_col((bounds_proc%endc_all - bounds_proc%begc_all + 1)*nvals_col))
