...
!hh!  use elm_varctl                 , only : use_cn, use_voc, use_c13, use_c14, use_fates, use_betr
...
!hh!  class(betr_simulation_elm_type), pointer            :: ep_betr
...
!hh!       if(use_betr)then
!hh!          call PlantMicKinetics_vars%Init(bounds_proc)
!hh!       endif
...
!hh!    call grc_es%Init(bounds_proc%begg_all, bounds_proc%endg_all)
!hh!    call lun_es%Init(bounds_proc%begl_all, bounds_proc%endl_all)
!hh!    call col_es%Init(bounds_proc%begc_all, bounds_proc%endc_all)
!hh!    call veg_es%Init(bounds_proc%begp_all, bounds_proc%endp_all)
    call grc_es%Init(bounds_proc%begg, bounds_proc%endg)
    call lun_es%Init(bounds_proc%begl, bounds_proc%endl)
    call col_es%Init(bounds_proc%begc, bounds_proc%endc)
    call veg_es%Init(bounds_proc%begp, bounds_proc%endp)
...
!hh!    call grc_ws%Init(bounds_proc%begg_all, bounds_proc%endg_all)
!hh!    call lun_ws%Init(bounds_proc%begl_all, bounds_proc%endl_all)
!hh!    call col_ws%Init(bounds_proc%begc_all, bounds_proc%endc_all, &
!hh!         h2osno_col(begc:endc),                    &
!hh!         snow_depth_col(begc:endc),                &
!hh!         soilstate_vars%watsat_col(begc:endc, 1:))
!hh!    call veg_ws%Init(bounds_proc%begp_all, bounds_proc%endp_all)
    call grc_ws%Init(bounds_proc%begg, bounds_proc%endg)
    call lun_ws%Init(bounds_proc%begl, bounds_proc%endl)
    call col_ws%Init(bounds_proc%begc, bounds_proc%endc, &
         h2osno_col(begc:endc),                    &
         snow_depth_col(begc:endc),                &
         soilstate_vars%watsat_col(begc:endc, 1:))
    call veg_ws%Init(bounds_proc%begp, bounds_proc%endp)

    call waterflux_vars%init(bounds_proc)

!hh!    call grc_wf%Init(bounds_proc%begg_all, bounds_proc%endg_all, bounds_proc)
!hh!    call col_wf%Init(bounds_proc%begc_all, bounds_proc%endc_all)
!hh!    call veg_wf%Init(bounds_proc%begp_all, bounds_proc%endp_all)
    call grc_wf%Init(bounds_proc%begg, bounds_proc%endg, bounds_proc)
    call col_wf%Init(bounds_proc%begc, bounds_proc%endc)
    call veg_wf%Init(bounds_proc%begp, bounds_proc%endp)
...
!hh!    call grc_ef%Init(bounds_proc%begg_all, bounds_proc%endg_all)
!hh!    call lun_ef%Init(bounds_proc%begl_all, bounds_proc%endl_all)
!hh!    call col_ef%Init(bounds_proc%begc_all, bounds_proc%endc_all)
!hh!    call veg_ef%Init(bounds_proc%begp_all, bounds_proc%endp_all)
    call grc_ef%Init(bounds_proc%begg, bounds_proc%endg)
    call lun_ef%Init(bounds_proc%begl, bounds_proc%endl)
    call col_ef%Init(bounds_proc%begc, bounds_proc%endc)
    call veg_ef%Init(bounds_proc%begp, bounds_proc%endp)


    call drydepvel_vars%Init(bounds_proc)
    call aerosol_vars%Init(bounds_proc)

    call frictionvel_vars%Init(bounds_proc, NLFilename = nlfilename)
